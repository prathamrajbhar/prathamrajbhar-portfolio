      ...
      <div className="flex flex-col gap-8">
        ...
        <AIAssistant<ProjectDTO>
          ...
          onFill={(data) => {
            ...
            if (typeof normalized.galleryImages === "string") {
              setGalleryImages(normalized.galleryImages.split("\n").filter(Boolean));
            } else if (Array.isArray(normalized.galleryImages)) {
              setGalleryImages(normalized.galleryImages);
            }
            const { galleryImages: _, ...formDataWithoutGallery } = normalized;
            setFormData(prev => ({ ...prev, ...formDataWithoutGallery }));
          }}
        />

        {/* Tab Selection */}
        <div className="flex flex-wrap gap-2 p-1.5 bg-surface/20 border border-border/40 rounded-2xl backdrop-blur-md">
          <button
            type="button"
            onClick={() => setActiveTab("general")}
            className={cn(
              "flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-xl text-xs font-bold uppercase tracking-wider transition-all cursor-pointer min-w-[120px]",
              activeTab === "general"
                ? "bg-primary text-bg shadow-lg shadow-primary/10 font-black"
                : "text-muted hover:text-text hover:bg-surface/30 font-bold"
            )}
          >
            <Layout size={14} />
            <span>General</span>
            {(errors.title || errors.slug || errors.description) && (
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
              ...
              >
                ...
                <Card className="overflow-hidden border-border/50 bg-surface/30 backdrop-blur-md">
                  ...
                  <div className="p-8 space-y-6">
                    ...
                    <label className="flex cursor-pointer items-center gap-3 group mt-2">
                      <div className={cn(
              ...
              >
                ...
                <Card className="overflow-hidden border-border/50 bg-surface/30 backdrop-blur-md">
                  <div className="flex items-center gap-3 border-b border-border/50 bg-bg/30 px-8 py-4">
                    ...
                    <h2 className="text-sm font-black uppercase tracking-widest text-text/80">Project Banner</h2>
                  </div>
                ...
                <Card className="overflow-hidden border-border/50 bg-surface/30 backdrop-blur-md">
                  <div className="flex items-center gap-3 border-b border-border/50 bg-bg/30 px-8 py-4">
                    ...
                    <h2 className="text-sm font-black uppercase tracking-widest text-text/80">Gallery screenshots</h2>
                  </div>
                  <div className="p-8 space-y-4">
              ...
              >
                ...
                <Card className="overflow-hidden border-border/50 bg-surface/30 backdrop-blur-md">
                  <div className="flex items-center gap-3 border-b border-border/50 bg-bg/30 px-8 py-4">
                    ...
                    <h2 className="text-sm font-black uppercase tracking-widest text-text/80">Case Study Details</h2>
                  </div>
                  <div className="p-8 space-y-6">
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                ...
                <Card className="overflow-hidden border-border/50 bg-surface/30 backdrop-blur-md">
                  <div className="flex items-center gap-3 border-b border-border/50 bg-bg/30 px-8 py-4">
                    ...
                    <h2 className="text-sm font-black uppercase tracking-widest text-text/80">Full Markdown Case Study</h2>
                  </div>
                  <div className="p-8 space-y-4">
                    <div className="flex items-center justify-between">
                ...
                <Card className="overflow-hidden border-border/50 bg-surface/30 backdrop-blur-md">
                  ...
                  <div className="p-8 space-y-6">
                    ...
                    <div className="space-y-4 border-t border-border/30 pt-6">
                      ...
                      <Button type="button" variant="outline" size="sm" onClick={addProjectLink} className="w-full rounded-xl cursor-pointer">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 border-t border-border/40 pt-6">
              ...
              {activeTab !== "general" && (
                <Button
                  ...
                  onClick={() => {
                    ...
                    else if (activeTab === "seo") setActiveTab("content");
                  }}
            ...
            <div className="flex gap-3 ml-auto">
              ...
              <Button type="submit" disabled={saving} className="h-12 px-8 rounded-xl shadow-lg shadow-primary/20 cursor-pointer">
                {saving ? (
                  <>
